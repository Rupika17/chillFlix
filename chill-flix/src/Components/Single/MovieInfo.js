  ...
  return (
    <div className="w-full xl:h-screen relative text-white">
      <img
        src={movie?.Poster}
        alt={movie?.Title}
        className="w-full hidden xl:inline-block h-full objet-cover"
      />
        ...
        <div className="container px-3 mx-auto 2xl:px-32 xl:grid grid-cols-3 flex-colo py-10 lg:py-20 gap-8">
          ...
          <div className="col-span-2 md:grid grid-cols-5 gap-4 items-center">
            <div className="col-span-3 flex-col gap-10">
              ...
              <div className="grid sm:grid-cols-5 grid-cls-3 gap-4 p-6 bg-main border border-gray-800 rounded-lg">
            ...
            <div className="col-sapn-2 md:mt-0 mt-2 flex justufy-end">
